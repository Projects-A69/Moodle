...
from src.crud.teacher_crud import approve_student_by_id
...
class TestApproveStudentById(unittest.TestCase):
    ...
    @patch("src.crud.teacher_crud.get_by_id")
    ...
    @patch("src.crud.teacher_crud.get_by_id")
    def test_approve_student_success_new_enrollment(self, mock_get_by_id):
        mock_get_by_id.return_value = self.student_user
